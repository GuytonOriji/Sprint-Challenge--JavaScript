...
const universities = [];
graduates.filter(function(a){universities.push(a.university)})
...
const contactInfo = [];
graduates.filter(function(a){contactInfo.push(`${a.first_name} ${a.email}`)})
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const unisWithUni = [];

graduates.filter(function(a){
  if(a.university.includes("Uni")){
    unisWithUni.push(a)
  }
})
...
// const sumUp = function (a, b) { return a + b.population; }; // 7
// populationTotal = zooAnimals.reduce( sumUp ,0) 
